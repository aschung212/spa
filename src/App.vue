...
// The shell owns this listener rather than WorkoutTracker: the tracker is
// unmounted on the Calendar and Weight tabs, so a message arriving there had
// nothing listening and the button did nothing. Record the intent and switch to
// Workouts — that is where the rest timer lives, and the mounting controller
// consumes what was recorded here (same handoff as the cold-boot URL above).
