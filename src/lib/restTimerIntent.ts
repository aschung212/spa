 ...
 *
 *   - **running app** → `client.postMessage` on the existing window
 ...
 * timer lives in WorkoutTracker, which has not mounted yet on a cold boot and may
 * never have mounted at all if the app relaunches onto the Calendar or Weight tab.
 *
